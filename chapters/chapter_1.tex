...
\begin{table}[htb]
\caption[Níveis de investigação -- \showfont]{Níveis de investigação. -- \showfont}
\label{tab-nivinv}
\resizebox{\textwidth}{!}{%
...
\begin{table}[!ht]
    \caption{Exemplo de tabela utilizando o pacote \emph{siunitx} e \emph{resizebox}  -- \showfont.}
...
\begin{figure}[htb]
    \caption{\label{fig_circulo}A delimitação do espaço -- \showfont}
    \begin{center}
...
\begin{figure}[htb]
    \caption{\label{fig_grafico}Gráfico produzido em Excel e salvo como PDF -- \showfont}
    \begin{center}
...
\centering
 \begin{minipage}{0.49\textwidth}
   \centering
   \caption{Imagem 1 da minipage -- \showfont} \label{fig_minipage_imagem1}
 ...
 \begin{minipage}{0.49\textwidth}
   \centering
   \caption{Gráfico 2 da minipage -- \showfont} \label{fig_minipage_grafico2}
...
\begin{quadro}
\caption{\label{quad:quadro_modelo1}Legenda do primeiro quadro. -- \showfont}
\centering
\begin{tabular}{|c|}
\hline
...
\begin{quadro}[htb]
\centering
\caption{\label{quad:quadro_modelo2}Legenda do segundo quadro. -- \showfont}
\begin{tabular}{|c|}
\hline
...
% ---
\section{Inclusão de código fonte -- \showfont}\label{sec-codeinsert}
% ---

\begin{lstlisting}[caption={Leitura dos dados simulados e conversão para estados topológicos. -- \showfont},label={lst:leituradadossim}]
...
\begin{lstlisting}[language=Python, caption=Python example -- \showfont]
import numpy as np
...
\begin{lstlisting}[language=TeX, caption=TeX example -- \showfont]
Ao nomear a \autoref{tab-nivinv} e a \autoref{fig_circulo}, apresentamos um
exemplo de remissão interna, que também pode ser feita quando indicamos o
\autoref{cap_exemplos}, que tem o nome \emph{\nameref{cap_exemplos}}. O número
do capítulo indicado é \ref{cap_exemplos}, que se inicia à
...
\begin{table}[htbp]
\caption{Tabela de conversão de acentuação. -- \showfont}
